...
- .large[pointing you in the direction of the basics for making your own palettes]
...
- .large[you don't need heaps of technical info on hex codes and colour theory for this to be fun an useful]
...
<a href="https://cran.r-project.org/web/packages/yarrr/vignettes/piratepal.html" target="_blank"><button class="button">📦 `dichromat`</button></a> - Collapse red-green or green-blue distinctions to simulate the effects of different types of color-blindness.
...
- [Colour Space package has lots of great information and palette options](http://colorspace.r-forge.r-project.org/articles/hcl_palettes.html)
...
-Things to think about - which colours do you put next to each other? [Visual blurring not good](https://datahero.com/blog/2013/08/08/why-color-matters-in-data-visualisation/)
